...
const G_USERS_COLUMN_GROUPS = [
  ...
  },
  {
    ...
    rows: [
      ...
      [
        ...
        'app_user.hierarchy_special_access_zc',
        'Texto/emails de acceso especial (Glide)',
      ],
      [
        'hierarchySpecialAccessCd',
        'app_user.hierarchy_special_access_cd',
        'Texto/emails de acceso especial (Glide)',
      ],
    ],
  },
  ...
  {
    id: 'glide_profile',
    title: 'Perfil Glide / prefs / T&C',
    subtitle: 'copy-users → app_user (antes en “sin migrar”)',
    rows: [
      ['systemKeyLeadLinker', 'app_user.system_key_lead_linker', ''],
      ['mediaIdMedia', 'app_user.media_id_media', 'Media perfil'],
      ['shift', 'app_user.shift', ''],
      ['Address', 'app_user.address', ''],
      ['profileShowRole / Hr / Comp', 'app_user.profile_show_*', ''],
      ['chartsHideVisuals1–4', 'app_user.charts_hide_visuals_*', ''],
      ['chartsShowVisuals1–4', 'app_user.charts_show_visuals_*', ''],
      ['intakePanelIntakePanelStepper', 'app_user.intake_panel_stepper', ''],
      ['intakePanelView*Section', 'app_user.intake_panel_view_*', ''],
      ['agreedtoT&C', 'app_user.agreed_to_tc', ''],
      ['signedtoT&C', 'app_user.signed_to_tc', 'URL de la firma (Glide), no boolean'],
      ['T&CTimestamp', 'app_user.tc_agreed_at', ''],
    ],
  },
  {
    id: 'not_migrated',
    title: 'Sin migrar (sesión / UI transitoria de Glide)',
    subtitle: 'No son perfil: callbacks, chat, booking, filtros de home',
    rows: [
      ['tglIntakePanel / selectDay / selectIntaker', '—', 'Estado de panel'],
      ['cbLeadId / cbLeadName / cbLeadPhone / cbId / cbTriggered', '—', 'Callback UI'],
      ['parametersViewIsConfirmed / parametersHomeList / dubCheck1', '—', 'Home params'],
      ['editPanelTgtLead / bookingForm* / chatChattingTo / isHotLeadTriggered', '—', 'Sesión'],
      ['tmpTgtForLdButton / dumbAi / showActiveLeadDb / profileDbSelector', '—', 'UI'],
      ['homescreenLoadingNlToday / scheduleList*Show/Hide*', '—', 'Dashboard toggle'],
    ],
  },
];
