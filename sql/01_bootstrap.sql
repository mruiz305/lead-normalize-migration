...
CREATE TABLE app_user (
  ...
  hierarchy_special_access_zc text DEFAULT NULL COMMENT 'g_users.hierarchySpecialAccessZc',
  hierarchy_special_access_cd text DEFAULT NULL COMMENT 'g_users.hierarchySpecialAccessCd',
  system_key_lead_linker varchar(50) DEFAULT NULL COMMENT 'g_users.systemKeyLeadLinker',
  media_id_media varchar(100) DEFAULT NULL COMMENT 'g_users.mediaIdMedia',
  shift varchar(50) DEFAULT NULL COMMENT 'g_users.shift',
  address text DEFAULT NULL COMMENT 'g_users.Address',
  profile_show_role tinyint(1) DEFAULT NULL COMMENT 'g_users.profileShowRole',
  profile_show_hr tinyint(1) DEFAULT NULL COMMENT 'g_users.profileShowHr',
  profile_show_comp tinyint(1) DEFAULT NULL COMMENT 'g_users.profileShowComp',
  charts_hide_visuals_1 tinyint(1) DEFAULT NULL COMMENT 'g_users.chartsHideVisuals1',
  charts_hide_visuals_2 tinyint(1) DEFAULT NULL COMMENT 'g_users.chartsHideVisuals2',
  charts_hide_visuals_3 tinyint(1) DEFAULT NULL COMMENT 'g_users.chartsHideVisuals3',
  charts_hide_visuals_4 tinyint(1) DEFAULT NULL COMMENT 'g_users.chartsHideVisuals4',
  charts_show_visuals_1 tinyint(1) DEFAULT NULL COMMENT 'g_users.chartsShowVisuals1',
  charts_show_visuals_2 tinyint(1) DEFAULT NULL COMMENT 'g_users.chartsShowVisuals2',
  charts_show_visuals_3 tinyint(1) DEFAULT NULL COMMENT 'g_users.chartsShowVisuals3',
  charts_show_visuals_4 tinyint(1) DEFAULT NULL COMMENT 'g_users.chartsShowVisuals4',
  intake_panel_stepper int DEFAULT NULL COMMENT 'g_users.intakePanelIntakePanelStepper',
  intake_panel_view_intake tinyint(1) DEFAULT NULL COMMENT 'g_users.intakePanelViewIntakeSection',
  intake_panel_view_demo tinyint(1) DEFAULT NULL COMMENT 'g_users.intakePanelViewDemoSection',
  intake_panel_view_insurance tinyint(1) DEFAULT NULL COMMENT 'g_users.intakePanelViewInsuranceSection',
  intake_panel_view_tx tinyint(1) DEFAULT NULL COMMENT 'g_users.intakePanelViewTxSection',
  intake_panel_view_atty tinyint(1) DEFAULT NULL COMMENT 'g_users.intakePanelViewAttySection',
  intake_panel_view_inj_and_dam tinyint(1) DEFAULT NULL COMMENT 'g_users.intakePanelViewInjAndDamSection',
  intake_panel_view_questionnaire tinyint(1) DEFAULT NULL COMMENT 'g_users.intakePanelViewQuestionnaireSection',
  intake_panel_view_psngr tinyint(1) DEFAULT NULL COMMENT 'g_users.intakePanelViewPsngrSection',
  agreed_to_tc tinyint(1) DEFAULT NULL COMMENT 'g_users.agreedtoT&C',
  signed_to_tc text DEFAULT NULL COMMENT 'g_users.signedtoT&C (URL firma)',
  tc_agreed_at datetime DEFAULT NULL COMMENT 'g_users.T&CTimestamp',
  synced_at datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id_user),
...
CREATE TABLE hierarchy_membership (
  ...
  is_active tinyint(1) NOT NULL DEFAULT 1,
  origin ENUM('GLIDE','PORTAL') NOT NULL DEFAULT 'PORTAL' COMMENT 'Quién administra la fila — GLIDE (derivada de g_users) | PORTAL (administrada por la app nueva)',
  synced_at datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (membership_id),
  UNIQUE KEY uk_hierarchy_membership (user_id, id_hierarchy_level, id_company_office, leader_user_id, is_leader),
  KEY idx_hierarchy_membership_origin (origin),
